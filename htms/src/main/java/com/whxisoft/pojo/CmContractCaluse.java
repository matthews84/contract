...
@XmlRootElement(name = "CmContractCaluse")
public class CmContractCaluse {
    @JSONField(name = "ID")
    private String ID;
    @JSONField(name = "GUID")
    private String GUID;
    private String strCaluseClass;
...
//    private String htdef20;
    ...
    public String getStrCaluseClass() {
        return strCaluseClass;
    }

    public void setStrCaluseClass(String strCaluseClass) {
        this.strCaluseClass = strCaluseClass;
    }
