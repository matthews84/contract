...
@XmlRootElement(name = "CmContractMemo")
public class CmContractMemo {
    @JSONField(name = "ID")
    private String ID;
    @JSONField(name = "GUID")
    private String GUID;
    private String strMemorabiliaID;
    private String strMemorabilia;
    private String strContractID;
    private String strWGDate;
...
//    private String htdef20;
    ...
    public String getStrMemorabiliaID() {
        return strMemorabiliaID;
    }

    public void setStrMemorabiliaID(String strMemorabiliaID) {
        this.strMemorabiliaID = strMemorabiliaID;
    }

    public String getStrMemorabilia() {
        return strMemorabilia;
    }

    public void setStrMemorabilia(String strMemorabilia) {
        this.strMemorabilia = strMemorabilia;
    }
    ...
    public String getStrWGDate() {
        return strWGDate;
    }

    public void setStrWGDate(String strWGDate) {
        this.strWGDate = strWGDate;
    }
    ...
    public String getcOperatorCode() {
        return cOperatorCode;
    }

    public void setcOperatorCode(String cOperatorCode) {
        this.cOperatorCode = cOperatorCode;
    }
